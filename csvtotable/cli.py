...
@click.option("-o", "--overwrite", default=False, is_flag=True, help="Overwrite the output file if exisits.")
@click.option("-s",
              "--serve",
              default=False,
              is_flag=True,
...
@click.option("-p", "--pagination", default=True, is_flag=True, help="Enable/disable table pagination.")
@click.option("-vs",
              "--virtual-scroll",
              type=int,
              default=1000,
...
@click.option("-nh", "--no-header", default=False, is_flag=True, help="Disable displaying first row as headers.")
@click.option("-e", "--export", default=True, is_flag=True, help="Enable filtered rows export options.")
@click.option("-eo",
              "--export-options",
